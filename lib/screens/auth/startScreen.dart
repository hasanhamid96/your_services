            ...
            children: [
              ...
              Container(
                  ...
                  child: RaisedButton.icon(
                    color: Colors.white,
                    icon: Icon(CupertinoIcons.person_add,size: 33,),
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(6)
                    ),
                    padding: EdgeInsets.symmetric(vertical: 10),
                    onPressed: (){
                      Navigator.of(context).push(CupertinoPageRoute(builder:(context) =>  LogScreen(isUser:  false,))) ;
                    },
                    label: Text('مستخدم',style: TextStyle(fontSize: 25,   fontFamily: 'Cairo-Regular',)),)),
              SizedBox(height: 10,),
              Container(
                  margin: EdgeInsets.symmetric(horizontal: 20),
                  width:double.maxFinite,
                  child: RaisedButton.icon(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 10),
                    onPressed: (){
                      Navigator.of(context).push(CupertinoPageRoute(builder:(context) =>  LogScreen(isUser:  true,))) ;

                    },label: Text('مقدم خدمة',style: TextStyle(fontSize: 25,   fontFamily: 'Cairo-Regular',)),)),
              SizedBox(height: 10,),
              Container(
                  margin: EdgeInsets.symmetric(horizontal: 20),
                  width:double.maxFinite,
                  child: RaisedButton.icon(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 10),
                    onPressed: (){
                      Navigator.of(context).push(CupertinoPageRoute(builder:(context) =>  LogScreen(isLogin:  true,))) ;

                    },label: Text('تسجيل دخول',style: TextStyle(fontSize: 25,   fontFamily: 'Cairo-Regular',)),)),
              SizedBox(height: 10,),
              // Container(
              //     margin: EdgeInsets.symmetric(horizontal: 20),
              //     width:double.maxFinite,
