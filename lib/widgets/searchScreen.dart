...
class _SearchScreenState extends State<SearchScreen> {
  ...
  GlobalKey<NestedScrollViewState> _key = GlobalKey<NestedScrollViewState>();
   ...
   PagingController<int, Person> _pagingController =  PagingController(firstPageKey: 0);
 ...
 //  }
           ...
           appBar:PreferredSize(
               ...
               child:     Container(
                 ...
                 decoration: BoxDecoration(
                     ...
                     border: Border(left: BorderSide.none,bottom: BorderSide(color: Colors.black26,width: 0.7))
                 ),
                 child:Row(
                   children: [
                     Container(
                       width: MediaQuery.of(context).size.width*0.85,
                       padding: const EdgeInsets.only(bottom: 8,right: 18,left: 18,top: 10),
                       child: CupertinoSearchTextField(
                         ...
                         onSubmitted: (value) async {
                           ...
                           searchString=value.toLowerCase();
                           Provider.of<Persons>(context, listen: false).clearAppointItems();
                           await Provider.of<Persons>(context, listen: false)
                               .searchPersonList(
                               search:value,
                             ).then((value){
                             setState(() {
                         ...
                         style: TextStyle(fontSize: 19.0, color: Colors.black,fontFamily: 'Tajawal-Regular',),
                       ),
                     ),
                     Transform.translate(
                       offset: Offset(0,0),
                                 ...
                                 CupertinoButton(
                                     ...
                                     onPressed: () async {
                                       ...
                                       print('first filtering...');
                                         Provider.of<Persons>(context, listen: false).clearSearch();
                                         await Provider.of<Persons>(context, listen: false)
                                             .filterPersonList(
                                             city_id: city_id,
                                             section_id: sec_id).then((value){
                                           setState(() {
                                             print(value);
                                             if(value==true)
                                               isSearched=false;
               ...
               builder: (context, sec, child)  {
                 if(sec.loadedSections.length==0&&isSearched)
                     ...
                     children: [
                       ListView.builder(
                         ...
                         itemBuilder: (context, index) =>
                             CraftPersonItem(person:sec.personItems[index]),
                       ),
                       if(isLoadingMore)
                         Container(
                       ...
                       if(sec.isNoMore)
                         Center(child: Text('ليس هنالك مزيد',
                             style: Theme
                                 .of(context)
                                 .textTheme
                                 .headline1)),
                   ...
                   return   ListView.builder(
                     ...
                     itemBuilder: (context, index) =>
                         SectionItem(
                             section: sec.loadedSections[index],city_id:city_id),);
                   return   Center(
                     child: Material(
                       ...
                       child: Column(
                         ...
                         children: [
                           Icon(Icons.person_search,color:  Colors.black12,size: 70,),
                           Padding(
                             padding: const EdgeInsets.only(right:13.0),
                             child: Text('أبحث الأن',style: TextStyle(color: CupertinoColors.activeOrange)),
                           ),
                         ],
                       )),
                   );
  ...
  _scrollListener() {
    ...
    if (scorllController.offset == scorllController.position.maxScrollExtent) {
      if (!Provider
          .of<Persons>(context, listen: false)
          .isNoMore) {
        print('there is more');
        if (mounted)
          setState(() {
        ...
        Provider.of<Persons>(context, listen: false).searchPersonList().then((
            value) {
          if (mounted)
            setState(() {
              isLoadingMore = false;
        ...
        child:Platform.isAndroid?AlertDialog(
          ...
          title: Row(
            ...
            children: [
              ...
              Text('...جاري التحميل',style: Theme.of(context).textTheme.bodyText2,),
            ],
          ),
