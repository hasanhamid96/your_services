...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        setState(() {
          ...
          if (UserProvider.type == 'provider') {
            ...
            if (!isLoadingCities)
              cityTitle = listCity
                  .firstWhere(
                      (element) => element.id.toString() == _person.city_id)
                  .title;
            if (!isLoadingSections)
              secTitle = listSec
                  .firstWhere(
                      (element) => element.id.toString() == _person.section_id)
                  .title;
          }
          if (UserProvider.type == 'user')
            _personDate = DateTime.parse(
                _person.birthDay == null ? DateTime.now() : _person.birthDay);

          Future.delayed(Duration(seconds: 1)).then(
              (value) => setState(() => {isLoading = false, once2 = true}));
        });
    });
  }
      ...
      navigationBar: CupertinoNavigationBar(
        trailing: Material(
          ...
          child: InkWell(
            ...
            child: Icon(FlutterIcons.logout_ant, size: 24, color: Colors.black),
          ),
        ),
        leading: Material(
          color: Colors.transparent,
        ...
        middle: Text('ملفي', style: Theme.of(context).textTheme.headline1),
                    ...
                    child: Form(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            if (_image != null)
                              imagePicker(mediaQuery, context),
                            if (_image == null &&
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  '${DateFormat('yyyy-MM-dd').format(_personDate)}'),
                                            ],
                                          ),
                                        ),
                                      ),
  ...
  Future<DateTime> getDate() {
    DateTime dateTime = DateTime(2010);
